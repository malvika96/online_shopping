	...
	<div class="products">	 
		<div class="container">
			<div class="col-md-9 product-model-sec">
				...
				<?php 
            $Id=$_GET['accbid'];
	$sql="SELECT DISTINCT b.accbid,a.aproductname,a.aprice,a.img1 from accproduct a,accbrand b, accmodel c,mobile_acc_category d,accgeneral e where a.accbid=b.accbid and a.accmid=c.accmid and a.acccategaryid=d.acccid and b.accbid='$Id' ";
	  	...
	  	?>	
               ...
               <div class="new-top">
					...
					<div class="new-bottom">
						...
						<h5><a class="name" href="single.html"><?php echo $row->aproductname;?> </a></h5>
                        <p>
						<div class="rating">
							<span class="on">☆</span>
							<span class="on">☆</span>
						...
						<div class="ofr">
							...
							<p><span class="item_price"><?php echo $row->aprice;?></span></p>
                            <a href="accquickview.php?accbid=<?php echo $row->accbid;?>"  class="btn btn-success">Quick View </a>
						</div>
