...
if(isset($_POST['submit']))
{
	...
	$sql="insert into accbrand(accbrandname) values('$bnm')";
...
<label class="col-sm-2 col-form-label"><b>Accessories Brand Name</b></label>
<div class="col-sm-5">
<input type="text" class="form-control" placeholder="Enter the name of Accessories Brand..." name="bname" >
</div>
</div>
