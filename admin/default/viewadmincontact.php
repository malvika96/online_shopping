...
{
	$id=intval($_GET['del']);
	$adn="delete from admin_contact where ac_id=?";
...
while($mem = mysqli_fetch_assoc($result))
	  {
	  	?>
                                    ...
                                    <tr class="gradeA odd">
                                            ...
                                            <td class=" "><?php echo $mem["address"];?></td>
                                            <td class=""><?php echo $mem["phone"];?></td>
                                            <td class=""><?php echo $mem["phone1"];?></td>
                                            <td class=""><?php echo $mem["mail"];?></td>
                       ...
                       data-whatever="<?php echo $mem["ac_id"];?>"><b><font color="#FFFFFF">Edit &nbsp;&nbsp;</b></a>&nbsp;&nbsp;
<a href="viewadmincontact.php?del=<?php echo $mem["ac_id"];?>" class="btn btn-danger fa fa-pencil" onclick="return confirm('Do you want to delete');"><b>Delete</b></a></td>
