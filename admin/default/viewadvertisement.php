...
{
	$id=intval($_GET['del']);
	$adn="delete from advertisement where advid=?";
...
while($mem = mysqli_fetch_assoc($result))
	  {
	  	?>
                                   <tr class="gradeA odd">
                                            ...
                                            <td class=" "><img src="images/<?php echo $mem["advimg"];?>" width="50" height="50"></td>
                                            
                                    
<td><a href="viewadvertisement.php?del=<?php echo $mem["advid"];?>" class="btn btn-danger fa fa-pencil" onclick="return confirm('Do you want to delete');"><b>Delete</b></a></td>
