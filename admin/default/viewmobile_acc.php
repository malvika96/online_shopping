...
{
	$id=intval($_GET['del']);
	$adn="delete from mobile_acc where mid=?";
...
while($row=$res->fetch_object())
	  {
	  	?>
                                    ...
                                    <tr class="gradeA odd">
                                            ...
                                            <td><a href="updatesemester.php?acccid=<?php echo $row->acccid;?>" class="btn btn-success fa fa-edit"><b>Edit</b></a>&nbsp;&nbsp;
<a href="viewmobile_acc.php?del=<?php echo $row->acccid;?>" class="btn btn-danger fa fa-pencil" onClick="return confirm('Do you want to delete');"><b>Delete</b></a></td>
