...
if(isset($_POST['submit']))
{
	...
	$name3=$_FILES['img4']['name'];
	$type3=$_FILES['img4']['type'];
	$size3=$_FILES['img4']['size'];
	$tmp3=$_FILES['img4']['tmp_name'];
	$upload3='images/'.$name3;
...
{
if(move_uploaded_file($tmp3,$upload3))
 {


	$sql="insert into productuplode(bid,mid,productname,price,ram,internalstorage,img1,img2,img3,img4,inthebox,modelnumber,color,brousetype,simtype,hybridsimslot,displaysize,resolution,resolutiontype,os,processortype,processercore,primarycamera,secondarycamera,networktype,supportednetwork,betterycapacity,width,height,depth,weight,warranty) values('$bname','$mname','$pnm','$pz','$ram','$is','$name','$name1','$name2','$name3','$itb','$mn','$clr','$bt','$st','$hss','$ds','$r','$rt','$os','$pt','$pc','$pcam','$sc','$nt','$sn','$bc','$w','$h','$d','$we','$ws')";
...
<label class="col-sm-2 col-form-label"><b>Upload image4</b></label>
<div class="col-sm-3">
