...
if(isset($_POST['submit']))
{
	...
	$sql="insert into accmodel(accbid,accmodelname) values('$bnm','$mnm')";
...
<div class="col-sm-5">
<select class="form-control" name="bname" onChange="change_model()" required="please input data" >
...
<div class="col-sm-5">
<input type="text" class="form-control" placeholder="Enter the name of Brand..." name="mname" >
</div>
</div>
