...
while($mem = mysqli_fetch_assoc($result))
	  {
	  	?>
                       ...
                       data-whatever="<?php echo $mem["bid"];?>"><b><font color="#FFFFFF">Edit &nbsp;&nbsp;</b></a>&nbsp;&nbsp;
<a href="viewbrand.php?del=<?php echo $mem["bid"];?>" class="btn btn-danger fa fa-pencil" onclick="return confirm('Do you want to delete');"><b>Delete</b></a></td>
